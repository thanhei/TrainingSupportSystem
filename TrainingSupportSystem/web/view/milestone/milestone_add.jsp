        ...
        <script>
            ...
            function f3() {
                ...
                if (enddate < todate && todate && enddate) {
                    var content = document.getElementById('check');
                    content.innerHTML = "<p id=\"check2\" style=\"color: red\">To date can't be smaller than From date</p>";
                }
                if ( enddate >= todate && date.value.length > min_chars && enddate && todate) {
            ...
            function f1() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        content.innerHTML = data;
                         var sel = document.getElementById("ass");
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        var content = document.getElementById("ass_body");
                        content.innerHTML=data;
            ...
            function loadAss(assName) {
                document.getElementById('name2').value = assName;
                window.alert("dcmm");
            }
                                                ...
                                                <div class="rounded shadow mt-4">
                                                    ...
                                                    <div class="p-4">
                                                        <form id="form2" action="milestone" method="Post">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input 
                                                                            ...
                                                                            required="" name="tittle" id="name2" type="text" class="form-control" placeholder="Tittle:" value="${first_ass}" readonly="readonly"  >
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3" id="content">
                                                                        ...
                                                                        <select id="ass" onchange="text()" style="width: 200px;text-align: center" class="form-control"  style="margin-right: 80px;" class="s_filter" name="ass_id"> 
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="mb-3">
                                                                    <label class="form-label">Assingment Body:</label>
                                                                    <textarea id="ass_body" rows="4" class="form-control" placeholder="Note :" name="ass_body" readonly="">${ass_body}</textarea>
                                                                </div>
                                                            </div>
