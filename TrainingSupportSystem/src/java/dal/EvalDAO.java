...
public class EvalDAO extends DBContext<Object> {
    ...
    public void insert(String ass_id, String mile_id, String eval_name) {
        try {
            String sql = "INSERT INTO `eval_criteria`\n"
                    ...
                    + "?)";
            PreparedStatement stm = conection.prepareStatement(sql);
            stm.setString(1, ass_id);
            stm.setString(2, mile_id);
            stm.setString(3, eval_name);
    ...
    public int getLastId() {
        try {
            String sql = "select  milestone_id from milestone order by milestone_id desc\n"
                    + "limit 1";
            PreparedStatement stm = conection.prepareStatement(sql);
            ResultSet rs = stm.executeQuery();
            while (rs.next()) {
