        ...
        switch (action) {
            case "add": {
                ...
                if (udb.checkRoleID(user.getUser_id(), 14)) {
                    ...
                    request.setAttribute("first_ass", alist.get(0).getTitle());
                    request.setAttribute("ass_body",mdb.getAssBody( alist.get(0).getAss_id()));
            ...
            case "load": {
                ...
                response.getWriter().print("<select id=\"ass\" onchange=\"text()\" style=\"width: 200px;text-align: center\" class=\"form-control\"  style=\"margin-right: 80px;\" class=\"s_filter\" name=\"ass_id\"> \n"
                        + "");
            ...
            case "load2": {
                ...
                String ass_body=mdb.getAssBody(ass_id);
                response.getWriter().print(ass_body);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            ...
            case "add": {
                ...
                mdb.add(m);
                EvalDAO edb=new EvalDAO();
               edb.insert(ass_id+"",edb.getLastId()+"" , "Thuyết Trình");
               edb.insert(ass_id+"",edb.getLastId()+"" , "Nội Dung");
